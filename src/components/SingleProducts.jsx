...
export const SingleProducts = () => {
  return (
    <div className="relative w-full bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      {/* discount */}
      <span className="bg-red-100 text-red-800 text-xs font-semibold w-[40px] h-[40px] flex items-center justify-center rounded-full dark:bg-red-200 dark:text-red-800 absolute -top-2 -right-2">
        -5%
      </span>
      <a href="#">
        <img
